...
const Home = () => {
  return (
    <main className="w-full" style={{backgroundImage: `url('')`}}>
      {/* start header */}
            ...
            <ul className="flex text-white">
              <li>
                <div className="flex items-center">
                  ...
                  <span className="ml-2">
                    Behind Cafe Coffee Day, Hazratganj, Lucknow
                  </span>
                </div>
              </li>
              <li className="ml-6">
                <div className="flex items-center">
                  ...
                  <span className="ml-2">6306248355</span>
                </div>
              </li>
            </ul>
          </div>
...
items-center min-h-screen"
          ...
          <div className="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
            <div>
              ...
              <p className="text-blue-100 text-xl md:text-2xl leading-snug mt-4">
                Welcome to the pathlogy lab of Dr. Venkatesh Naidu where trust and
        ...
        <div className="flex flex-col lg:flex-row lg:-mx-8">
          <div className="w-full lg:w-1/2 lg:px-8">
            <h2 className="text-3xl leading-tight font-bold mt-4">
              Welcome to the pathology lab of Dr.Venkatesh Naidu
            </h2>
            <p className="mt-2 leading-relaxed">
              {" "}
              At Naidu PathLabs, we are dedicated to providing top-notch diagnostic
              services with a focus on accuracy, reliability, and patient care. Our
              state-of-the-art facilities are equipped with the latest technology
              and instruments, ensuring that we deliver precise and timely results.
            </p>
          </div>
          <div className="w-full lg:w-1/2 lg:px-8 mt-12 lg:mt-0">
            <div className="md:flex">
              ...
              <div className="md:ml-8 mt-4 md:mt-0">
                ...
                <p className="mt-2 leading-relaxed">
                  Our comprehensive services allow you to receive all needed health
                  care right here in our state-of-art office – from blood test to
                  full body checkups.
                </p>
              </div>
            </div>
            <div className="md:flex mt-8">
              ...
              <div className="md:ml-8 mt-4 md:mt-0">
                ...
                <p className="mt-2 leading-relaxed">
                  Your treatment plan will perfectly match your needs, lifestyle,
                  and goals. Even if it’s been years since you last visited the
                  laboratory, we can help. Our comfortable office, compassionate
                  team, and minimally-invasive treatments will help you feel
                  completely at ease.
                </p>
              </div>
            </div>
        ...
        <div className="md:flex md:flex-wrap mt-24 text-center md:-mx-4">
          <div className="md:w-1/2 md:px-4 lg:w-1/4">
            <div className="bg-white rounded-lg border border-gray-300 p-8">
              <img
                src="https://redcliffelabs.com/myhealth/_next/image/?url=https%3A%2F%2Fmyhealth-redcliffelabs.redcliffelabs.com%2Fmedia%2Fblogcard-images%2F3590%2F8f328418-085a-4cf6-8284-9470342d3c71.jpg&w=1920&q=75"
                alt=""
                className="h-20 mx-auto"
              />
              <h4 className="text-xl font-bold mt-4">Blood Test</h4>
              <p className="mt-1">Let us show you how our experience.</p>
              <Link href="/blood-test" className="block mt-4">
                Read More
              </Link>
            </div>
          </div>
          <div className="md:w-1/2 md:px-4 mt-4 md:mt-0 lg:w-1/4">
            <div className="bg-white rounded-lg border border-gray-300 p-8">
              <img
                src=" https://www.radolabs.in/wp-content/uploads/2023/03/LIVER-FUNCTION-TEST.png"
                alt=""
                className="h-20 mx-auto"
              />
              <h4 className="text-xl font-bold mt-4">Liver Function Test(LFT)</h4>
              <p className="mt-1">Let us show you how our experience.</p>
              <Link href="liver-test" className="block mt-4">
                Read More
              </Link>
            </div>
          </div>
          <div className="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4">
            <div className="bg-white rounded-lg border border-gray-300 p-8">
              <img
                src=" https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjHC5wnAQweX2-iZ2INejoXoKH8wHmPSZLNA&s"
                alt=""
                className="h-20 mx-auto"
              />
              <h4 className="text-xl font-bold mt-4">Kidney Function Test(KFT)</h4>
              <p className="mt-1">Let us show you how our experience.</p>
              <Link href="kidney-test" className="block mt-4">
                Read More
              </Link>
            </div>
          </div>
          <div className="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4">
            <div className="bg-white rounded-lg border border-gray-300 p-8">
              <img
                src=" https://www.diabetes.co.uk/wp-content/uploads/2019/01/plasma-fasting-glucose.jpg"
                alt=""
                className="h-20 mx-auto"
              />
              <h4 className="text-xl font-bold mt-4">Blood Glucose Test</h4>
              <p className="mt-1">Let us show you how our experience.</p>
              <Link href="blood-glucose-test" className="block mt-4">
                Read More
              </Link>
      ...
      <section className="relative bg-gray-100 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-16 lg:py-32">
        <div className="flex flex-col lg:flex-row lg:-mx-8">
          <div className="w-full lg:w-1/2 lg:px-8">
            <h2 className="text-3xl leading-tight font-bold mt-4">
              Why choose the NaiduPathLabs ?
            </h2>
            <p className="mt-2 leading-relaxed">
              {" "}
              Our state-of-the-art technology and rigorous quality control measures
              ensure that every test result is accurate and reliable. We understand
              the importance of precise diagnostics in guiding effective treatment
              plans.Our highly skilled team of pathologists, laboratory technicians,
              and support staff are committed to excellence. With years of
              experience and continuous training, our team is adept at handling even
              the most complex cases with precision and care.
            </p>
          </div>
          <div className="w-full md:max-w-md md:mx-auto lg:w-1/2 lg:px-8 mt-12 mt:md-0">
            <div className="">
              <img
                ...
                src="https://images.pexels.com/photos/24706228/pexels-photo-24706228/free-photo-of-glass-bottles-in-light.jpeg?auto=compress&cs=tinysrgb&w=800"
                alt=""
              />
            </div>
      ...
      <footer className="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
        <div className="flex flex-col md:flex-row">
          <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
            <h3 className="font-bold text-2xl">Naidu PathLabs</h3>
            <p className="text-gray-400">Share your overall experience </p>
            ...
            <ul className="mt-4">
              ...
              <li className="mt-4">
                ...
                >
                  ...
                  <span className="ml-3">
                    Mon - Fri: 9:00am to 6:00pm Closed on Weekends
                  </span>
                </a>
              </li>
              <li className="mt-4">
                ...
                >
                  ...
                  <span className="ml-3">6306248333</span>
                </a>
              </li>
              <li className="mt-4">
                <a
                ...
                >
                  ...
                  <span className="ml-3">naidu007@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
          <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
            ...
            <p className="text-sm text-gray-400 mt-12">
              © 2012 NaiduPathLabs <br className="hidden lg:block" />
              All Rights Reserved.
            </p>
          </div>
        </div>
